...
### DRAWBACKS
 - Vuejs is SPA in default so its HTML file are generated by JavaScript and Render it in Client Side. it is not best approach to SEO (Search Engine Optimization).
